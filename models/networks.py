...
# def seresnet50(feature_dim, use_pool, use_dropout):
#     """
#     We follow https://github.com/Cadene/pretrained-models.pytorch for convenient.
#     """
#     net_list = list(list(pretrainedmodels.__dict__['se_resnet50'](pretrained=None).children())[:-2])
#     net_list[0].conv1 = torch.nn.Conv2d(3, 64, kernel_size=3, stride=1, padding=1, bias=False)
#     if use_pool:
#         net_list += [nn.AdaptiveAvgPool2d((1, 1))]
#     net_list += [Flatten()]
#     if use_dropout:
...
#     else:
#         # todo: need to test
#         net_list += [nn.Linear(2048*4*3, feature_dim)]
#
#     return  nn.Sequential(*net_list)
